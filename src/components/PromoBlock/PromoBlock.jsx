...
export const PromoBlock = () => {
  ...
  return (
    <section className={styles.promoBlock}>
      <header className={styles.promoBlock__header}><h2>Веб-студия Котики</h2><h3 className={styles.promoBlock__subheader}>сделаем ваш сайт настолько красивым, что вы будете мурчать от удовольствия :)</h3></header>
      <section className={styles.promoBlock__benefits}>
        <div className={activeBenefit == 1 ? styles.behefits__benefit + " " + styles.behefits__benefit_active : styles.behefits__benefit} onClick={() => setActiveBenefit(1)}><FeatherIcon icon="code" />4 веб-разработчика</div>
